...
const getLevelInfo = (code: string) => {
  switch (code.toUpperCase()) {
    case 'PRE-A1':
      return {
        title: 'Novice',
        desc: 'Extremely basic words, word-by-word help.',
      };
    case 'A1':
      return { title: 'Beginner', desc: 'Simple sentences, everyday words.' };
    case 'A2':
      return {
        title: 'Elementary',
        desc: 'Routine tasks and basic descriptions.',
      };
    case 'B1':
      return {
        title: 'Intermediate',
        desc: 'Familiar topics and standard input.',
      };
    case 'B2':
      return {
        title: 'Upper Intermediate',
        desc: 'Main ideas of complex text.',
      };
    case 'C1':
      return { title: 'Advanced', desc: 'Implicit meaning and long texts.' };
    case 'C2':
      return { title: 'Mastery', desc: 'Virtually everything with ease.' };
    default:
            ...
            <form onSubmit={handleRequestOutline} className="space-y-6">
              ...
              <div className="space-y-3">
                  ...
                  {CEFR_LEVELS.map((level) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-3.5 border rounded-lg text-left transition-all duration-200 flex flex-col items-start gap-1 cursor-pointer bg-tj-bg-card hover:border-tj-primary ${
                          isSelected
                            ? 'border-tj-primary bg-tj-bg-recessed ring-1 ring-tj-primary/20'
                            : 'border-tj-border-main'
                        }`}
                      >
                        <span
                          className={`text-[9px] font-mono font-bold uppercase py-0.5 px-2 rounded-sm ${getCefrBadgeStyle(level.code)}`}
                        >
                          {level.code}
                        </span>
                        <h4 className="text-[11px] font-bold text-tj-text-main leading-tight mt-1">
                          {info.title}
                        </h4>
                        <p className="text-[10px] text-tj-text-muted leading-snug mt-0.5 font-sans">
                          {info.desc}
                        </p>
                      </button>
                    );
                ...
                {selectedLevelObj && (
                  ...
                  >
                    <strong>Guide:</strong> {selectedLevelObj.description}
                  </motion.p>
                )}
                {(cefrLevel === 'A1' || cefrLevel === 'Pre-A1') && (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-2">
                    <label className="relative flex items-start gap-3 select-none cursor-pointer group">
                      <input
                        type="checkbox"
                        checked={!isPublic}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 bg-slate-50 dark:bg-slate-800/25 border border-slate-100 dark:border-slate-800/80 rounded-2xl animate-fade-in">
                <div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="md:col-span-2 pt-4 border-t border-slate-200/50 dark:border-slate-800/80 mt-2">
                      ...
                      <p className="text-[10px] text-slate-400 mt-1">
                        {isThinkingActive
                          ...
                          : 'Adjust randomness. Lower values (e.g. 0.3 - 0.5) are more focused and factual, higher values (e.g. 0.9 - 1.2) are more creative.'}
                      </p>
                    </div>
                  );
                })()}
