      ...
      <AnimatePresence mode="wait">
        {!showOutlineReview ? (
          ...
          >
            ...
            {creationMode === 'gemini_embed' ? (
              <form onSubmit={handleImportGeminiSubmit} className="space-y-6">
                <div className="p-4 bg-emerald-500/10 border border-emerald-500/20 rounded-xl text-xs text-emerald-700 dark:text-emerald-300 space-y-1">
                  ...
                  <p>
                    Paste a shared story link created with Google Gemini's
                    Storybook Gem (e.g.,{' '}
                ...
                <div className="flex items-center justify-between p-4 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/50">
                  <div>
                    ...
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                      Allow other learners to read this story on the public
                      library
                    </p>
                  </div>
                  <button
                  ...
                  {(cefrLevel === 'A1' || cefrLevel === 'Pre-A1') && (
                    <div className="space-y-2 mt-4 animate-fade-in pl-1">
                      ...
                      <p className="text-[10px] text-slate-405 dark:text-slate-400 leading-normal">
                        ...
                        word-by-word/phrase-by-phrase mapping in the
                        translation. This also changes the target translation
                ...
                <div className="space-y-3">
                  ...
                  {(genre === 'nonfiction' || writingType === 'expository') && (
                    <div className="mt-2.5 p-3 bg-amber-50 dark:bg-amber-950/20 text-amber-700 dark:text-amber-400 text-xs rounded-xl border border-amber-100 dark:border-amber-950/30 flex items-start gap-2 animate-fade-in">
                      ...
                      <span>
                        <strong>Hallucination Warning:</strong> Factual and
                        informational topics generated by AI may contain
                        inaccuracies or hallucinations, especially when
                        simplified for language learning.
                      </span>
                    </div>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                      <Layers className="w-4 h-4 text-tj-primary" />
                      Book Length (
                      {writingType === 'narrative' ? 'Chapters' : 'Sections'})
                    </label>
                  ...
                  <div>
                    <label className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                      ...
                      {writingType === 'narrative' ? 'Chapter' : 'Section'} Word
                      Count
                    </label>
                    <div className="flex items-center gap-3">
                      <input
                        ...
                        <div className="flex items-start gap-2.5 text-xs">
                          ...
                          <div>
                            ...
                            <p className="text-[11px] text-tj-text-muted mt-0.5 leading-relaxed">
                              Create an account to choose AI models, generate
                              custom stories, or use custom API keys.
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="relative inline-flex items-center">
                          ...
                          <AnimatePresence>
                            {showPrivateTooltip && (
                              ...
                              >
                                Only you will be able to view and read this
                                story. Quotas: Free tier allows up to 10
                                elective private stories, Paid/Premium allows up
                                to 100. Stories flagged as containing
                                copyrighted material are automatically kept
                                private and don't count toward this limit.
                              </motion.div>
                            )}
                          </AnimatePresence>
                        </div>
                    ...
                    <div className="flex items-start gap-3 text-left">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                          Create custom graded stories, export to DRM-free eBook
                          formats, and practice vocabulary. Free daily
                          generations during our limited-time launch!
                        </p>
                      </div>
                    </div>
                    {onLogin && (
