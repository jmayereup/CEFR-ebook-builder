    ...
    <AnimatePresence>
      {selectedWord && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-50 w-full max-h-[50dvh] flex flex-col bg-tj-bg-card border-t border-tj-border-main shadow-[0_-10px_25px_-5px_rgba(0,0,0,0.1),0_-8px_10px_-6px_rgba(0,0,0,0.1)] select-text touch-pan-x"
          drag="y"
            ...
            {selectedWord.saveSuccess ? (
              ...
              <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-stretch lg:items-start gap-3 lg:gap-6">
                ...
                <div className="flex flex-col gap-2.5 min-w-[240px] lg:w-96 lg:max-w-md">
                  {/* Row 1: Word Heading + Pronounce & Word Navigation + Close */}
                  <div className="flex items-center justify-between gap-2">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      ...
                      <button
                        ...
                        className="p-1.5 bg-tj-bg-card hover:bg-tj-bg-recessed rounded-xl text-slate-400 hover:text-tj-text-main border border-tj-border-main cursor-pointer shadow-2xs flex items-center justify-center ml-1"
                        title="Close toast"
                      >
                    ...
                    <div className="flex items-center gap-1.5 shrink-0">
                      ...
                      {setAutoPlayWord && (
                        <button
                          ...
                          className={`px-1.5 py-0.5 md:px-2 md:py-1 rounded-xl border cursor-pointer shadow-2xs flex items-center justify-center shrink-0 transition-colors text-[11px] md:text-xs gap-1 ${
                            autoPlayWord
                    ...
                    <div className="flex flex-col gap-1.5 pt-1.5 border-t border-tj-border-main/60">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {HIGHLIGHT_COLORS.map((c) => {
                            ...
                            return (
                              <button
                                ...
                                className={`w-5 h-5 md:w-6 md:h-6 rounded-full border ${c.dotClass} flex items-center justify-center transition-transform hover:scale-110 active:scale-95 cursor-pointer shadow-2xs ${
                                  isSelected
                        ...
                        <button
                          ...
                          className={`p-1 px-2 md:p-1.5 md:px-2.5 rounded-xl border transition-colors cursor-pointer flex items-center gap-1 text-xs font-semibold ${
