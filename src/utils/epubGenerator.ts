...
import { isNonFictionGenre, type Story } from '../types';
...
<body>
  <div class="title-container">
    ...
    ${
      isNonFictionGenre(story.genre)
        ? `<div class="disclaimer-box">
      <strong>AI Disclaimer:</strong> This content was generated by AI for language learning practice. Facts and details have not been independently verified.
    </div>`
        : ''
    }
    ${
