...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="BookId" version="3.0" prefix="rendition: http://www.idpf.org/vocab/rendition/#">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    ...
    <dc:creator>${stripBranding ? escapeXml(story.title || 'Anonymous') : 'Easy eBooks'}</dc:creator>
...
<body>
  <div class="title-container">
    ...
    <div class="disclaimer-box">
      <strong>AI Disclaimer:</strong> Generated by AI for language learning and reading practice. Facts and details have not been independently verified. Not intended as medical, legal, financial, or safety advice. Fictional characters, names, and situations do not depict or represent real living persons.
    </div>
    ${
      stripBranding
        ? ''
