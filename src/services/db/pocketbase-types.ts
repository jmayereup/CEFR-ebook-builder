...
export type AiLessonsLanguageOptions =
  (typeof AiLessonsLanguageOptions)[keyof typeof AiLessonsLanguageOptions];
...
export type AiLessonsTranslationLanguageOptions =
  (typeof AiLessonsTranslationLanguageOptions)[keyof typeof AiLessonsTranslationLanguageOptions];
...
export type DahootOptionsTypeOptions =
  (typeof DahootOptionsTypeOptions)[keyof typeof DahootOptionsTypeOptions];
...
export type DahootPlayersRecord<
  Tanswers = unknown,
  Tlap_question_ids = unknown,
  Tmarathon_stats = unknown,
> = {
...
export type DahootQuestionsTypeOptions =
  (typeof DahootQuestionsTypeOptions)[keyof typeof DahootQuestionsTypeOptions];
...
export type DahootRoomsStatusOptions =
  (typeof DahootRoomsStatusOptions)[keyof typeof DahootRoomsStatusOptions];

export const DahootRoomsPacingModeOptions = {
  teacher: 'teacher',
  student: 'student',
} as const;
export type DahootRoomsPacingModeOptions =
  (typeof DahootRoomsPacingModeOptions)[keyof typeof DahootRoomsPacingModeOptions];
...
export type DahootUserInfoRoleOptions =
  (typeof DahootUserInfoRoleOptions)[keyof typeof DahootUserInfoRoleOptions];
...
export type DeletionFlagsReasonOptions =
  (typeof DeletionFlagsReasonOptions)[keyof typeof DeletionFlagsReasonOptions];
...
export type DeletionFlagsStatusOptions =
  (typeof DeletionFlagsStatusOptions)[keyof typeof DeletionFlagsStatusOptions];
...
export type LessonsLanguageOptions =
  (typeof LessonsLanguageOptions)[keyof typeof LessonsLanguageOptions];
...
export type LessonsTagsOptions =
  (typeof LessonsTagsOptions)[keyof typeof LessonsTagsOptions];
...
export type StoriesCopyrightFlagSourceOptions =
  (typeof StoriesCopyrightFlagSourceOptions)[keyof typeof StoriesCopyrightFlagSourceOptions];
export type StoriesRecord<
  Tchapters = unknown,
  TcompletedBy = unknown,
  TconsistencyAudits = unknown,
  Tratings = unknown,
  TstoryBible = unknown,
> = {
  cefrLevel?: string;
...
export type UsersRecord<
  TbeginnerLessons = unknown,
  Tbookshelf = unknown,
  TgenerationLimitData = unknown,
  TpersonalWordBank = unknown,
  Tplaylist = unknown,
  TrecentlyRead = unknown,
  TsavedVocab = unknown,
  Tstreak = unknown,
> = {
...
export type WorksheetsLanguageOptions =
  (typeof WorksheetsLanguageOptions)[keyof typeof WorksheetsLanguageOptions];
...
export type WorksheetsLevelOptions =
  (typeof WorksheetsLevelOptions)[keyof typeof WorksheetsLevelOptions];
...
export type WorksheetsTagsOptions =
  (typeof WorksheetsTagsOptions)[keyof typeof WorksheetsTagsOptions];
...
export type WorksheetsLessonTypeOptions =
  (typeof WorksheetsLessonTypeOptions)[keyof typeof WorksheetsLessonTypeOptions];
...
export type AiLessonsResponse<Tcontent = unknown, Texpand = unknown> = Required<
  AiLessonsRecord<Tcontent>
> &
  BaseSystemFields<Texpand>;
export type DahootGamesResponse<Texpand = unknown> =
  Required<DahootGamesRecord> & BaseSystemFields<Texpand>;
export type DahootOptionsResponse<Texpand = unknown> =
  Required<DahootOptionsRecord> & BaseSystemFields<Texpand>;
export type DahootPlayersResponse<
  Tanswers = unknown,
  Tlap_question_ids = unknown,
  Tmarathon_stats = unknown,
  Texpand = unknown,
> = Required<
  DahootPlayersRecord<Tanswers, Tlap_question_ids, Tmarathon_stats>
> &
  BaseSystemFields<Texpand>;
export type DahootQuestionsResponse<
  Toptions = unknown,
  Texpand = unknown,
> = Required<DahootQuestionsRecord<Toptions>> & BaseSystemFields<Texpand>;
export type DahootRoomsResponse<
  Tquestion_ids = unknown,
  Texpand = unknown,
> = Required<DahootRoomsRecord<Tquestion_ids>> & BaseSystemFields<Texpand>;
export type DahootSettingsResponse<Texpand = unknown> =
  Required<DahootSettingsRecord> & BaseSystemFields<Texpand>;
export type DahootUserInfoResponse<Texpand = unknown> =
  Required<DahootUserInfoRecord> & BaseSystemFields<Texpand>;
export type DeletionFlagsResponse<Texpand = unknown> =
  Required<DeletionFlagsRecord> & BaseSystemFields<Texpand>;
export type GenerationLogsResponse<Texpand = unknown> =
  Required<GenerationLogsRecord> & BaseSystemFields<Texpand>;
export type LessonsResponse<Twordbank = unknown, Texpand = unknown> = Required<
  LessonsRecord<Twordbank>
> &
  BaseSystemFields<Texpand>;
export type PictureDescriptionsResponse<
  Tcontent = unknown,
  Texpand = unknown,
> = Required<PictureDescriptionsRecord<Tcontent>> & BaseSystemFields<Texpand>;
...
export type StoryHighlightsResponse<Texpand = unknown> =
  Required<StoryHighlightsRecord> & BaseSystemFields<Texpand>;
export type TeamGamesResponse<Texpand = unknown> = Required<TeamGamesRecord> &
  BaseSystemFields<Texpand>;
export type TjComponentsTeacherInfoResponse<Texpand = unknown> =
  Required<TjComponentsTeacherInfoRecord> & BaseSystemFields<Texpand>;
export type TjwcSubmissionsResponse<Texpand = unknown> =
  Required<TjwcSubmissionsRecord> & BaseSystemFields<Texpand>;
...
> &
  AuthSystemFields<Texpand>;
export type WorksheetsResponse<
  Tcontent = unknown,
  TcustomConfig = unknown,
  Texpand = unknown,
> = Required<WorksheetsRecord<Tcontent, TcustomConfig>> &
  BaseSystemFields<Texpand>;
