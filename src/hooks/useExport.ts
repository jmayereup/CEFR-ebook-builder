...
export function useExport(options: UseExportOptions) {
  ...
  const triggerCopyPlaintext = () => {
    ...
    if (!stripBranding) {
      textString += `Generated on Easy eBooks\n`;
    }
    textString += `[AI Disclaimer: Generated by AI for language learning and reading practice. Facts and details have not been independently verified. Not intended as medical, legal, financial, or safety advice. Fictional content does not depict real persons or events.]\n`;
    textString += `\n`;
  ...
  const triggerCopyRichText = () => {
    ...
    let htmlContent = `
      <div style="font-family: 'Georgia', serif; line-height: 1.5; color: #1e293b; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="font-size: 12px; color: #64748b; margin-bottom: 24px; font-family: 'Helvetica Neue', Arial, sans-serif; text-align: center;">
          <strong>AI Disclaimer:</strong> Generated by AI for language learning and reading practice. Facts and details have not been independently verified. Not intended as medical, legal, financial, or safety advice. Fictional content does not depict real persons or events.
        </div>
    `;
