...
export function useExport(options: UseExportOptions) {
  ...
  const triggerCopyPlaintext = () => {
    ...
    if (isNonFictionGenre(selectedStory.genre)) {
      textString += `[AI Disclaimer: This content was generated by AI for language learning practice. Facts and details have not been independently verified.]\n`;
    }
    textString += `\n`;
  ...
  const triggerCopyRichText = () => {
    ...
    if (isNonFictionGenre(selectedStory.genre)) {
      htmlContent += `
        <div style="background-color: #fffbe6; border: 1px solid #ffe58f; border-radius: 6px; padding: 10px 14px; font-size: 13px; color: #734a00; margin-bottom: 24px; font-family: 'Helvetica Neue', Arial, sans-serif;">
